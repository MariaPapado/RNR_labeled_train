...
dataset_path = '/home/mariapap/DATASETS/dataset_FP_v1/test/'
...
keep_ids= []
for id in ids:
    label = Image.open('/home/mariapap/DATASETS/dataset_FP_v1/test/label/{}'.format(id))
...
modified_resnet.load_state_dict(torch.load('./saved_models/net_15.pt', weights_only=True))  ###@@@@@@ this gave gasune 14 14
